...
breaks_sigma  <- c(30, 60, 80, Inf)
levels_sigma  <- c("30 ≤ σₑ (km/s) < 60", "60 ≤ σₑ (km/s) < 80", "80 ≤ σₑ (km/s) ≤ 317")
...
extremos_df <- extremos_df %>%
  mutate(
    ...
    vjust_label = case_when(
      painel_full_id == "30 ≤ σₑ (km/s) < 60___< 14"   & modelo == "fSFG" & tipo_ponto == "min" ~ -1.0,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___< 14"   & modelo == "fLTG" & tipo_ponto == "min" ~  1.5,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___< 14"   & modelo == "fSFG" & tipo_ponto == "max" ~ -0.1,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___< 14"   & modelo == "fLTG" & tipo_ponto == "max" ~  1.6,
      
      painel_full_id == "60 ≤ σₑ (km/s) < 80___< 14"   & modelo == "fSFG" & tipo_ponto == "min" ~ -1.0,
      painel_full_id == "60 ≤ σₑ (km/s) < 80___< 14"   & modelo == "fLTG" & tipo_ponto == "min" ~  1.5,
      painel_full_id == "60 ≤ σₑ (km/s) < 80___< 14"   & modelo == "fSFG" & tipo_ponto == "max" ~ -0.7,
      painel_full_id == "60 ≤ σₑ (km/s) < 80___< 14"   & modelo == "fLTG" & tipo_ponto == "max" ~  1.6,
      
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 317___< 14"  & modelo == "fSFG" & tipo_ponto == "min" ~ -1.0,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 317___< 14"  & modelo == "fLTG" & tipo_ponto == "min" ~  1.5,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 317___< 14"  & modelo == "fSFG" & tipo_ponto == "max" ~ -0.7,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 317___< 14"  & modelo == "fLTG" & tipo_ponto == "max" ~  1.6,
      
      painel_full_id == "30 ≤ σₑ (km/s) < 60___≥ 14"   & modelo == "fSFG" & tipo_ponto == "min" ~ -1.2,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___≥ 14"   & modelo == "fLTG" & tipo_ponto == "min" ~  1.4,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___≥ 14"   & modelo == "fSFG" & tipo_ponto == "max" ~ -0.8,
      painel_full_id == "30 ≤ σₑ (km/s) < 60___≥ 14"   & modelo == "fLTG" & tipo_ponto == "max" ~  1.5,
...
ggsave(path = wdfigs,
       filename = paste0("logistic_IHM_logvelDisp_oldbin.pdf"),
