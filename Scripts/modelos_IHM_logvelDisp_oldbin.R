...
bins_velDisp <- c(30, 60, 80, 10^(max(data.s$logvelDisp_e)))
...
ordem_bins <- c(
  "[30, 60)", 
  "[60, 80)", 
  paste0("[80, ", round(10^vetor_prob[length(vetor_prob)]), "]")
)
...
extremos_df <- extremos_df %>%
  mutate(
    ...
    vjust_label = case_when(
      painel_full_id == "[30, 60)___< 14"   & modelo == "fSFG" & tipo_ponto == "min" ~ 0.5,
      painel_full_id == "[30, 60)___< 14"   & modelo == "fLTG" & tipo_ponto == "min" ~  1.7,
      painel_full_id == "[30, 60)___< 14"   & modelo == "fSFG" & tipo_ponto == "max" ~ 0.5,
      painel_full_id == "[30, 60)___< 14"   & modelo == "fLTG" & tipo_ponto == "max" ~  1.7,
      
      painel_full_id == "[60, 80)___< 14"   & modelo == "fSFG" & tipo_ponto == "min" ~ 0.8,
      painel_full_id == "[60, 80)___< 14"   & modelo == "fLTG" & tipo_ponto == "min" ~  1.5,
      painel_full_id == "[60, 80)___< 14"   & modelo == "fSFG" & tipo_ponto == "max" ~ 0.8,
