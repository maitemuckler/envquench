...
extremos_df <- extremos_df %>%
  mutate(
    ...
    vjust_label = case_when(
      ...
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 200___< 14"  & modelo == "fSFG" & tipo_ponto == "min" ~ -1.0,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 200___< 14"  & modelo == "fLTG" & tipo_ponto == "min" ~  1.5,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 200___< 14"  & modelo == "fSFG" & tipo_ponto == "max" ~ -0.7,
      painel_full_id == "80 ≤ σₑ (km/s) ≤ 200___< 14"  & modelo == "fLTG" & tipo_ponto == "max" ~  1.6,
...
ggsave(path = wdfigs,
       filename = paste0("logistic_LIM_logMgroup14.pdf"),
