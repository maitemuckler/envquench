...
input_data <- "inputdata_zmax0.03_Rlim2.5_Ma12.3_flag_good==1_MANGLE_logMstar_min9.17"

df    <- fread(paste0(wddata, "environmental-quenching-data/inputModel/", input_data, ".csv"))
